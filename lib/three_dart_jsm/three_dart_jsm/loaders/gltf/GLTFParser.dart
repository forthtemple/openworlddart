...
class GLTFParser {
  ...
  _markDefs() {
    ...
    for (var skinIndex = 0, skinLength = skinDefs.length;
  ...
  loadMaterial(materialIndex) async {
    ...
    var json = this.json;
    var extensions = this.extensions;
    //print("xxx"+json["materials"].toString());
    ...
    //print("ooo"+materialType.toString()+"mmm"+materialDef.toString());
   ...
   /* if (materialDef['name'].contains(".jpg")) {
      materialDef["normalTexture"]={'index':0};
    }*/
